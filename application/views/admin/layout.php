...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b> SMAN 1 BALAPULANG</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ...
                <p>
                  <?php echo $value->nama;?>
                  <small>Admin Perpus SMAN 1 BALAPULANG</small>
                </p>
                <?php
              }
              ?>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logo.jpg" alt="" srcset="" width="47px" style="border-radius: 50%;">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="">SMAN 6 WAJO</a>.</strong> 
  </footer>
